...
export const SeguimientosContainer = styled(motion.div)``;
...
export const ContainerFilters = styled.div`
  ...
  align-items: center;
`;
export const ContainerSegEstado = styled.div`
  display: flex;
  flex-direction: row;
  align-items: center;
  gap: 10px;
  ...
  margin-right: 60px;
`;
export const ContainerSegAccion = styled.div`
  display: flex;
  flex-direction: row;
  align-items: center;
  span {
  ...
  margin-right: 60px;
`;
export const ContainerSegFechas = styled.div`
  display: flex;
  flex-direction: row;
  align-items: center;
  span {
